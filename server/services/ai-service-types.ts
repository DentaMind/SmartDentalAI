...
export const SERVICE_TYPE_TO_KEY_MAP: Record<AIServiceType, string> = {
  ...
  [AIServiceType.TREATMENT_PLANNING]: 'OPENAI_API_KEY_TREATMENT',
  [AIServiceType.XRAY]: 'OPENAI_API_KEY_XRAY',
  [AIServiceType.XRAY_ANALYSIS]: 'OPENAI_API_KEY_XRAY',
  ...
  [AIServiceType.PATIENT_COMMUNICATION]: 'OPENAI_API_KEY_COMMUNICATION',
