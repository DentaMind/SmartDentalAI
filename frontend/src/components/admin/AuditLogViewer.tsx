...
import { fetchEventTypes, fetchAuditLogs } from '../../api/audit';
...
export const AuditLogViewer: React.FC = () => {
  ...
  const exportToCsv = () => {
    ...
    const headers = ['ID', 'Event Type', 'User ID', 'Patient ID', 'Resource Type', 'Resource ID', 'IP Address', 'Timestamp', 'Metadata'];
    const csvContent = [
      headers.join(','),
      ...logs.map(log => [
        log.id,
