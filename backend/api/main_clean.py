"""
Main FastAPI application for the DentaMind API.
This version has been adjusted to work with FastAPI 0.88.0 and Pydantic 1.10.8 
to avoid the "'not' is not a valid parameter name" error.
"""
