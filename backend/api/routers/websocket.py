...
class ConnectionManager:
    ...
    async def disconnect(self, websocket: WebSocket):
        if websocket in self.active_connections:
            ...
            client_info = self.connection_info.get(id(websocket), {})
    ...
    def get_connection_stats(self) -> Dict[str, Any]:
        return {
            ...
            "clients": list(
                {info["client_id"] for info in self.connection_info.values()}
            )
        }
...
async def get_room_list(
    ...
    stats = connection_manager.get_connection_stats()
    return {
        "rooms": stats["active_connections"],
        "timestamp": datetime.now().isoformat()
    }
...
async def test_websocket_connection(
    ...
    try:
        ...
        pre_test_stats = connection_manager.get_connection_stats()
        ...
        return ConnectionTestResult(
            ...
            details={
                "connections": pre_test_stats["active_connections"],
                "clients": pre_test_stats["clients"],
            },
